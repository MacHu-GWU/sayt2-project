...
- Fix ``DataSet.build_index`` not clearing the existing tantivy index before rebuilding, causing documents to be duplicated on each rebuild. The index directory is now removed and recreated from scratch.
